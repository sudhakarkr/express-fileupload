...
module.exports = (options, req, res, next) => {
  ...
  busboy.on('file', (field, file, info) => {
    ...
    // parseFileName sanitizes the incoming filename to strip any path
    // components / traversal sequences before it can be used as a destination
    // file name (see lib/utilities.js sanitizeFileName).
